...
const RejectOrderModal = ( { onBtnClick }: CloseRejectedModalPropsType ) => {
  ...
  return (
    <div className={ style.rejectOrderModalContainer }>
      ...
      <p>Измените количество товара в корзине и повторите заказ.</p>
      <Button title={ 'Вернуться в корзину' } onClick={ onBtnClick }/>
    </div>
  );
};
